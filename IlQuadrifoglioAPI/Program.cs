...
using IlQuadrifoglioAPI.Services;
using System;
using System.Text;
using System.Threading.Tasks;

namespace IlQuadrifoglioAPI
{
        ...
        public static async Task Main(string[] args)
        {
            ...
            builder.Services.AddCors(options =>
            {
                options.AddPolicy("AllowOrigin",
                    builder => builder.WithOrigins("https://localhost:7281", "https://ilquadrifoglio.azurewebsites.net") //add new address form azure
                                      .AllowAnyMethod()
                                      .AllowAnyHeader());
            });
            ...
            var googleMapsApiKey = Environment.GetEnvironmentVariable("GoogleMapsApiKey") ?? builder.Configuration["GoogleMaps:ApiKey"];
